      ...
      <div className="relative mx-auto max-w-md px-5">
        ...
        {sortedRounds.length === 0 && (
          <motion.div
            ...
            className="mt-16 rounded-[42px] border border-white/70 bg-white/[0.62] p-10 text-center shadow-[0_18px_55px_rgba(15,23,42,0.10)] backdrop-blur-2xl"
          >
            <div
              className="text-7xl"
              aria-hidden="true"
            ...
            <button
              ...
              className="mt-8 w-full rounded-[28px] bg-emerald-500 py-5 text-lg font-black text-white shadow-[0_18px_45px_rgba(16,185,129,0.28)]"
            >
              Runde starten
            </button>
          </motion.div>
          ...
          {sortedRounds.map((round, index) => {
            ...
            return (
              <motion.button
                ...
                className="w-full overflow-hidden rounded-[42px] border border-white/70 bg-white/[0.62] text-left shadow-[0_18px_55px_rgba(15,23,42,0.10)] backdrop-blur-2xl transition-all duration-300 hover:shadow-[0_24px_70px_rgba(15,23,42,0.14)]"
              >
                  ...
                  <div className="relative">
                    ...
                    <div className="mt-8 flex items-end justify-between gap-5">
                      <div>
                        ...
                        <div
                          className={`mt-2 text-6xl font-black tracking-[-0.06em] ${getMoneyColorDark(displayEarnings)}`}
                        >
                      ...
                      <div className="text-right">
                        ...
                        <div
                          className={`mt-2 text-5xl font-black tracking-[-0.055em] ${getToParColorDark(winner?.totalToPar)}`}
                        >
                ...
                <div className="p-6">
                  <div className="grid grid-cols-2 gap-3">
                    <div className="rounded-[24px] border border-white/70 bg-white/[0.58] p-4 shadow-sm backdrop-blur-xl">
                    ...
                    <div className="rounded-[24px] border border-white/70 bg-white/[0.58] p-4 text-right shadow-sm backdrop-blur-xl">
                      <div className="text-xs font-black uppercase tracking-widest text-slate-400">
                        Flight
                      </div>
                  ...
                  <div className="mt-4 rounded-[26px] border border-white/70 bg-white/[0.58] p-5 shadow-sm backdrop-blur-xl">
                    <div className="min-w-0">
